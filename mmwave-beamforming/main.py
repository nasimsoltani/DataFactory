...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_path', default='/home/batool/Directroy/', type=str, help='base path of whole wall including images and pickle file')
    ...
    parser.add_argument('--wall_model_path', default='/home/batool/Directroy/Wall/model/',help='path of wall model')
    parser.add_argument('--wall_model_json', default='/home/batool/Directroy/Wall/model/Wall_model.json', help = "restore json files from here")
    parser.add_argument('--wall_model_weight', default='/home/batool/Directroy/Wall/model/wall_model_weights.hdf5',help='restore weights from')
